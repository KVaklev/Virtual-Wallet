namespace VirtualWallet.Helpers
{
    public class Text
    {
        ...
        public const string OurFirstValue = "We prioritize the security and privacy of our users' digital assets. " +
             "We implement advanced encryption and employ the latest security protocols. ";

        public const string OurSecondValue = "We strive to bring cutting-edge features and improvements to our virtual wallet platform " +
            "to enhance the user experience continually. ";

        public const string OurThirdValue = "Our users are at the heart of everything we do. We actively listen to their feedback and suggestions" +
            "or meet their needs and preferences.";

        public const string OurMission =
            "Revolutionize the way individuals manage and interact with their digital assets. We aim to provide a secure, user-friendly, " +
            "and accessible platform that empowers users to take full control of their digital journey.";
  
        public const string OurVision = 
            "We strive to be the go-to platform for individuals seeking a reliable, innovative, and transparent virtual wallet solution.";
        ...
        //Constant messages for Security menu
